...
Frontend:
  - expo-web/: Expo Router (React Native for Web + Mobile)
...
This is your complete implementation specification. Use the individual prompts in Section 10 to guide LLM-assisted development of each component. Each prompt is self-contained and provides all necessary context for implementation.